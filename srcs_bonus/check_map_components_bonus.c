...
/*   Updated: 2022/05/11 15:36:15 by ateak            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	map_components_amount(t_game *map, t_symbol *map_components)
{
	...
	if (map->data[map_components->i][map_components->j] == 'C')
		map_components->item_score++;
	if (map->data[map_components->i][map_components->j] == 'P')
	{
		map_components->player_score++;
		map->player_pos_x = map_components->j;
		map->player_pos_y = map_components->i;
	}	
	if (map->data[map_components->i][map_components->j] == 'B')
		map_components->enemy_score++;
}
